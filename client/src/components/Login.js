          ...
          {/* Inputs */}
           ...
           <form action={handleFormSubmit}>
            <div className='flex flex-col items-center justify-center'>
             <input type='email' value={formState.email} onChange={handleChange} className='rounded-2xl px-2 py-1 w-4/5 md:w-full border-[1px] border-blue-400 m-1 focus:shadow-md focus:border-emerald
             -400 focus:outline-none focus:ring-0' placeholder='Email'></input>
             <input type="password" value={formState.password} onChange={handleChange} className='rounded-2xl px-2 py-1 w-4/5 md:w-full border-[1px] border-blue-400 m-1 focus:shadow-md focus:border-emerald
